...
/* ---------- 색 ---------- */
const BIGCOLOR = {
  "식비": "#B33A5A", "카페/간식": "#C4695F", "배달": "#A24A66", "술/유흥": "#8E3B63",
  "교통": "#3E6E8E", "여행": "#2F7D8C", "공과금": "#5C6F9C", "통신": "#4A7BA7", "주거": "#6B7A99",
  "의료/건강": "#0F7B6C", "뷰티/미용": "#3F8F7A", "운동": "#2F8F6E",
  "편의점/마트": "#8A6A3E", "온라인쇼핑": "#A2803F", "패션/잡화": "#9A5F3C",
  "문화/여가": "#6D5AA8", "교육": "#5B58A0", "경조/선물": "#B0553F",
  "금융/세금": "#7A8494", "이체/저축": "#5C6F9C", "생활서비스": "#7E8AA0", "반려동물": "#7E9A5C",
  "수입": "#0F7B6C", "기타": "#98A2B3",
};
