...
async function ensureAuth() {
  ...
  try {
    ...
    /* 무슨 일이든 "비밀번호가 맞지 않습니다" 로 뭉개면 안 된다.
       서버에 PASSWORD 가 비어 있는 것을 이 한 줄 때문에 몇 번이나 못 찾았다.
       서버가 한 말을 그대로 옮긴다. */
    toast(String(e && e.message ? e.message : e), 4000);
    return false;
  }
}
