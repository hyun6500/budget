...
function romanceHTML(which) {
  ...
  const list = isIntro ? (P.intro || []) : (P.love || []);
  ...
  return hero + routeCard + makerCard + yearCard + meetCard + tblCard;
}
